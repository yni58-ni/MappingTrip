    ...
    ui(new Ui::pathDialog)
{
    ...
    map<int, string> mapCoor;
    mapElements.insert(pair<int,string>(01,"Western University"));
    mapElements.insert(pair<int,string>(02,"Huron University College"));
    mapElements.insert(pair<int,string>(03,"Victoria Park"));
    mapElements.insert(pair<int,string>(04,"Sifton Bog"));
    mapElements.insert(pair<int,string>(05,"CF Masonville Place"));
    mapElements.insert(pair<int,string>(06,"Brescia University College"));
    mapElements.insert(pair<int,string>(07,"Talbot College"));
    mapElements.insert(pair<int,string>(08,"St. Joseph's Hospital"));
    mapElements.insert(pair<int,string>(09,"Museum Strathroy Caradoc"));
    ...
    void pathDialog::on_shortPath_clicked(int startID, int endID){           //Dijkstra algorithm
